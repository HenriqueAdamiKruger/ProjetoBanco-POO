...
namespace ProjetoBanco
{
    public partial class frmPrincipal : Form
    {
        ...
        public frmPrincipal(Usuario usuarioLogado)
        {
            ...
            this.labelNomeUsuario.Text = this.usuarioLogado.login;

            this.labelSaldo.Text = '$' + System.Convert.ToString(this.usuarioLogado.saldo);
        }
